...
- **No velocity clamp.** The reference clamps to `0.2 * thickness / dt` to stop fast material tunnelling through thin features. Not built. Add it in `integrate` if tunnelling shows up in a shot.
